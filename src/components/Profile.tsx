...
const ProfileCard: React.FC = () => {
  return (
    <>
      ...
      <div className="max-w-md p-8 my-8 sm:flex sm:space-x-6 dark:dark:bg-gray-900 dark:dark:text-gray-100">
        ...
        <div className="flex flex-col space-y-4">
          <div>
            ...
            <span className="text-sm dark:dark:text-gray-400">General manager</span>
          </div>
          <div className="space-y-1">
            <span className="flex items-center space-x-2">
              ...
              <span className="dark:dark:text-gray-400">leroy.jenkins@company.com</span>
            </span>
            <span className="flex items-center space-x-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      {/* // 1111111111111111111 end */}
      <div className="p-6 sm:p-12 my-8 dark:dark:bg-gray-900 dark:dark:text-gray-100">
