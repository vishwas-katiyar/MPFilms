    ...
    <div className="container my-24 mx-auto md:px-6 text-white">
      <section className="mb-32 text-center">
        <p className="mb-16 text-7xl font-bold">
          Why is it so<u> great?</u>
        </p>
        <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
          <div className="my-[6rem] md:mb-0">
            <div className="mb-6 inline-block rounded-md bg-current p-4">
              <svg
          ...
          <div className="my-[6rem] md:mb-0">
            ...
            <h2 className="mb-4 font-bold text-5xl">Extremely fast</h2>
            <p className="text-neutral-500 font-medium dark:text-neutral-300">
